...
from openlxp_P1_notification.management.utils.notification import (
    send_notifications, send_notifications_with_msg)
from openlxp_P1_notification.management.utils.ses_client import \
...
class UtilsTests(TestSetUp):
    ...
    def test_check_if_email_verified(self):
        ...
        with patch('openlxp_P1_notification.management.utils.ses_client'
    ...
    def test_send_notifications(self):
        ...
        with patch('openlxp_P1_notification.management.utils.notification'
                   '.EmailMessage') as mock_send, \
                patch('openlxp_P1_notification.management.utils.ses_client'
                      '.boto3.client'), \
                patch('openlxp_P1_notification.management.utils.notification'
                      '.send_notifications'), \
                patch(
                    'openlxp_P1_notification.management.utils.notification.'
